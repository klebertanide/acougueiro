    ...
    try:
        ...
        with open(csv_path, "w", newline="", encoding="utf-8") as f:
            ...
            for tempo, prompt_texto, bloco in prompts_com_tempo:
                ...
                prompt_completo = f"{tempo_inicio}, {prompt_texto}, fear, dread, terror, panic, phobia, fright, frightening, terrifying, frightening. cruelty, monstrosity, barbarity, atrocity, hideousness, savagery, inhumanity, bestiality, crime, macabreness. misfortune, unhappiness, sadness, dissatisfaction, displeasure, displeasure, setback, difficulty, misfortune, misfortune, misfortune, bad luck, annoyance, suffering, pain, suffering, annoyance, displeasure."
